...
print(f"First eye position:         {first_eye_pos}")
print(f"First eye target position:  {first_eye_target}")
print(f"Second eye position:        {second_eye_pos}")
print(f"Second eye target position: {second_eye_target}")
print()

distance_between_throw_positions = vector_magnitude(
        (first_eye_pos[0] - second_eye_pos[0], first_eye_pos[1] - second_eye_pos[1])
)
